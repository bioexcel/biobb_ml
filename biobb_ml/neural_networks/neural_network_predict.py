...
class ClassificationNeuralNetwork():
    ...
    Args:
        input_model_path (str): Path to the input dataset. Accepted formats: csv.
...
def main():
    ...
    required_args.add_argument('--input_model_path', required=True, help='Path to the input dataset. Accepted formats: csv.')
