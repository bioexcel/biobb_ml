...
* Installation:
        ...
        conda install -c bioconda "biobb_ml>=3.6.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_ml:3.6.1--pyh53442f1_0


* Usage:


        docker run quay.io/biocontainers/biobb_ml:3.6.1--pyh53442f1_0 <command>
