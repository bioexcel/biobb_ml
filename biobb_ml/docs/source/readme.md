...
* Installation:
        ...
        conda install -c bioconda "biobb_ml>=3.7.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_ml:3.7.0--pyhdfd78af_1


* Usage:


        docker run quay.io/biocontainers/biobb_ml:3.7.0--pyhdfd78af_1 <command>
