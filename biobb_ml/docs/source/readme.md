...
* Installation:
        ...
        conda install -c bioconda "biobb_ml>=3.0.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_ml:3.0.0--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_ml:3.0.0--py_0 <command>
