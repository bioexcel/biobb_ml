...
htmlhelp_basename = 'biobb_ml_doc'
...
latex_documents = [
    (master_doc, 'biobb_ml.tex', u'biobb_ml Documentation',
...
man_pages = [
    (master_doc, 'biobb_ml', u'biobb_ml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_ml', u'biobb_ml Documentation',
     author, 'biobb_ml', 'biobb_ml molecular dynamics ml building blocks',
     'Miscellaneous'),
]
