...
decision_tree -h
```
    /bin/sh: decision_tree: command not found
### I / O Arguments
...
```
    /bin/sh: agglomerative_clustering: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
linear_regression -h
```
    /bin/sh: linear_regression: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: random_forest_classifier: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
resampling -h
```
    /bin/sh: resampling: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: classification_predict: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: principal_component: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: spectral_clustering: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: random_forest_regressor: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: logistic_regression: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
pls_components -h
```
    /bin/sh: pls_components: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: pairwise_comparison: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
k_neighbors -h
```
    /bin/sh: k_neighbors: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: support_vector_machine: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: regression_neural_network: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: polynomial_regression: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
scale_columns -h
```
    /bin/sh: scale_columns: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: autoencoder_neural_network: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
k_means -h
```
    /bin/sh: k_means: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
map_variables -h
```
    /bin/sh: map_variables: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: regression_predict: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
dendrogram -h
```
    /bin/sh: dendrogram: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: agglomerative_coefficient: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: recurrent_neural_network: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
dummy_variables -h
```
    /bin/sh: dummy_variables: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: clustering_predict: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
undersampling -h
```
    /bin/sh: undersampling: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: correlation_matrix: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
oversampling -h
```
    /bin/sh: oversampling: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: neural_network_decode: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
pls_regression -h
```
    /bin/sh: pls_regression: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: k_means_coefficient: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: spectral_coefficient: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: neural_network_predict: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
drop_columns -h
```
    /bin/sh: drop_columns: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
dbscan -h
```
    /bin/sh: dbscan: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: k_neighbors_coefficient: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
```
    /bin/sh: classification_neural_network: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
