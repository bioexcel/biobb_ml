...
class SupportVectorMachine():
    ...
    def launch(self) -> int:
        ...
        Examples:
            This is a use example of how to use the SupportVectorMachine module from Python

            >>> from biobb_ml.classification.support_vector_machine import SupportVectorMachine
            >>> prop = { 'independent_vars': { 'columns': [ 'column1', 'column2', 'column3' ] }, 'target': { 'column': 'target' }, 'kernel': 'rbf', 'test_size': 0.2 }
            >>> SupportVectorMachine(input_dataset_path='/path/to/myDataset.csv', output_model_path='/path/to/newModel.pkl', output_test_table_path='/path/to/newTable.csv', output_plot_path='/path/to/newPlot.png', properties=prop).launch()
