...
class RandomForestClassifier(BiobbObject):
    """
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`RandomForestClassifier <classification.random_forest_classifier.RandomForestClassifier>` classification.random_forest_classifier.RandomForestClassifier object."""
        ...
        # classification
        fu.log('Training dataset applying random forest classification', self.out_log, self.global_log)
        model = ensemble.RandomForestClassifier(n_estimators = self.n_estimators,  bootstrap = self.bootstrap, random_state = self.random_state_method)
...
def random_forest_classifier(input_dataset_path: str, output_model_path: str, output_test_table_path: str = None, output_plot_path: str = None, properties: dict = None, **kwargs) -> int:
...
def main():
    ...
    random_forest_classifier(input_dataset_path=args.input_dataset_path,
