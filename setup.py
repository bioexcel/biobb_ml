...
setuptools.setup(
    ...
    install_requires=['biobb_common==3.0.0', 'scikit-learn ==0.22.2.post1', 'pandas ==1.0.3', 'seaborn ==0.10.1', 'tensorflow ==2.1.0rc2-cp37-cp37m-manylinux2010_x86_64', 'h5py ==v2.10.0'],
    python_requires='==3.7.*',
    classifiers=(
